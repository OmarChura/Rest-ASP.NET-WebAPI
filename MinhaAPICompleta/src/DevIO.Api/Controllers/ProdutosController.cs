...
namespace DevIO.Api.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        {
            var fornecedor = _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.ObterProdutosFornecedores());
        ...
        public async Task<ActionResult<ProdutoViewModel>> AdicionarAlternativo(
            ...
            //[ModelBinder(BinderType = typeof(JsonConfigurationExtensions))]
